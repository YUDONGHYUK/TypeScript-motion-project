...
class App {
  ...
  constructor(appRoot: HTMLElement, dialogRoot: HTMLElement) {
    ...
    //   'Video title',
    //   'https://www.youtube.com/watch?v=wWjkiG_aTrY'
    // );
    ...
    // const todo = new TodoComponent('Todo Title', 'Todo Checkbox');
    ...
    const todoBtn = document.querySelector('#new-image')! as HTMLButtonElement;
